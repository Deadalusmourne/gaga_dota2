# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-12-01 09:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo_sponsor', models.IntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('account_id', models.IntegerField(db_index=True, unique=True)),
            ],
        ),
        migrations.AddField(
            model_name='leaguematches',
            name='lobby_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='logic.LobbyType'),
        ),
        migrations.AddField(
            model_name='leaguematches',
            name='radiant_team',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='radiant_team', to='logic.Club'),
        ),
    ]
